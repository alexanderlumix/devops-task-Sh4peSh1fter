...
const (
	uri = "mongodb://appuser:appuserpassword@haproxy-lb:27034/appdb?directConnection=true" // not using replicaSet because it doesn't work with directConnection=true
)
